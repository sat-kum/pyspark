#bucketing is works only in spark dataframe
...
orderdf.write.format("csv").mode("overwrite").bucketBy(4, "order_customer_id").sortBy("order_customer_id").saveAsTable('retail.order4')